...
public:
    ...
    static const unsigned int TIMERS = 4; //(???? 0+1 2+3)
    ...
    enum {
        ...
        I2C0_BASE                   = 0x10002000, // I2C
        GPIOA_BASE                  = 0x10013000, // GPIO 0
        GPIOB_BASE                  = 0x10014000, // GPIO 1
        GPIOC_BASE                  = 0x10015000, // GPIO 2
        ...
        // GPIOE_BASE                  = 0x10013000, // 0x10013000 GPIO 0 (????)
        TIMER0_BASE                 = 0x10011000, // Timer 0+1
        TIMER1_BASE                 = 0x10011000, // Timer 0+1
        TIMER2_BASE                 = 0x10012000, // Timer 2+3
        TIMER3_BASE                 = 0x10012000, // Timer 2+3
        // ADC0_BASE                   = 0x40038000, // ADC
        
        FLASH0_BASE                 = 0x40000000, // Configuration flash (????)
        SCR_BASE                    = 0x10001000, // System Control
        GIC0_BASE                   = 0x1e000000  // GIC1. (PB)
        GIC1_BASE                   = 0x1e001000  // GIC2. (PB)
        GIC2_BASE                   = 0x1e002000  // GIC3. (PB)
        GIC3_BASE                   = 0x1e003000  // GIC4. (PB)
